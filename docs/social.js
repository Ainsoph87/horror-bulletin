...
(function () {
  ...
  const COMPOSER = {
    ...
    // FB e IG non hanno deeplink al composer che regga (i deeplink vengono interpretati come
    // profili inesistenti): si apre la home, il composer lo si apre a mano.
